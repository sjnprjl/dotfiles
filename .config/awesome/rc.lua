...
{description = "run thunar file manager", group = "my custom"})
--]]
)
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox" },
    properties = { screen = 1, tag = awful.util.tagnames[1],maximized=false , floating=false} },
