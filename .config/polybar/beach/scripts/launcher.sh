...
FILE="$HOME/.config/polybar/beach/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/beach/scripts/rofi/launcher.rasi
